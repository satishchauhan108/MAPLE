# The following code is for "tabular regression" task.
...
def evaluate_model(model, test_loader):
    # In this task, we use MAE, MSE, and RMSE metrics to evaluate the regression accuracy.
    ...
    # Define the `y_true` for ground truth and `y_pred` for the predicted values here.
...
def main():
    """
    Main function to execute the tabular regression pipeline.
    """
