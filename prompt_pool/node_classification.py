# The following code is for "node classification" task using PyTorch.
...
from torch_geometric import data, datasets, transforms, profile
...
def evaluate_model(model, test_loader):
    # In this task, we use the ACC and F1 metrics to evaluate the node classification performance.
...
def main():
    """
    Main function to execute the node classification pipeline.
    """
