# The following code is for "image classification" task using PyTorch.
...
def evaluate_model(model, test_loader):    
    # In this task, we use Accuracy and F1 metrics to evaluate the classification performance.
    ...
    # Define the `y_true` for ground truth and `y_pred` for the predicted results here.
...
def main():
    ...
    # If specified, please directly load the dataset into train, valid, and test splits.
    dataset = None
    ...
    # You may skip this step (Step 2) if the train-valid-test or train-test split is already provided or separately loaded.
