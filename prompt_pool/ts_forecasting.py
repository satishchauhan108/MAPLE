# The following code is for "time-series forecasting" task using PyTorch.
...
def evaluate_model(model, test_loader):    
    # In this task, we use MAE and MSE metrics to evaluate the forecasting accuracy.
...
def main():
    """
    Main function to execute the time-series forecasting pipeline.
    """
